        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              _pdfRow(
                'Adults:',
                '${managementcontroller.visitorDetails?.adultCount ?? 0} × ₹${adultPrice.toStringAsFixed(0)} = ₹${((managementcontroller.visitorDetails?.adultCount ?? 0) * adultPrice).toStringAsFixed(0)}',
                ttf,
              ),
              _pdfRow(
                'Children:',
                '${managementcontroller.visitorDetails?.childCount ?? 0} × ₹${childPrice.toStringAsFixed(0)} = ₹${((managementcontroller.visitorDetails?.childCount ?? 0) * childPrice).toStringAsFixed(0)}',
                ttf,
              ),
